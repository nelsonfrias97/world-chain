...
use reth::{api::Block, rpc::server_types::eth::utils::recover_raw_transaction, transaction_pool::{
    ...
    Client: BlockReaderIdExt + StateProviderFactory + 'static,
{
    async fn send_raw_transaction_conditional(
        ...
        let mut pool_transaction: WorldChainPooledTransaction = EthPooledTransaction::from_pooled(recovered).into();
